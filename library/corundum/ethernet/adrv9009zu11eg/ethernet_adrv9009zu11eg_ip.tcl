...
adi_ip_create ethernet_adrv9009zu11eg
...
adi_ip_properties_lite ethernet_adrv9009zu11eg

set cc [ipx::current_core]

set_property display_name "Corundum Ethernet ADRV9009ZU11EG" $cc
set_property description "Corundum Ethernet Core IP" $cc
set_property company_url {https://analogdevicesinc.github.io/hdl/library/corundum/ethernet/ethernet_adrv9009zu11eg} [ipx::current_core]
...
adi_if_infer_bus analog.com:interface:if_qsfp master m_qsfp [list \
  "rx_p  qsfp_rx_p" \
  "rx_n  qsfp_rx_n" \
  "tx_p  qsfp_tx_p" \
  "tx_n  qsfp_tx_n" \
  "mgt_refclk_p  qsfp_mgt_refclk_p" \
  "mgt_refclk_n  qsfp_mgt_refclk_n" \
]
